    ...
    <div className="sidebar section-long order-lg-last">
        ...
        {movies.map((movie) => {
          return (
            <div className="movie-short-line-entity" key={movie._id}>
              <Link href={`/movie/${movie._id}`}><a className="entity-preview">
                  <img
                    className="w-100"
                    src={movie.poster}
                    alt="movie poster"
              ...
              <div className="entity-content">
                ...
                <Link href={`/movie/${movie._id}`}><a
                    className="content-link"
                  >
                    {movie.title}
                  </a></Link>
                </h4>
                <p className="entity-subtext">{formattedDate(movie.released)}</p>
              </div>
            </div>
        )})}
      </section>
      <section className="section-sidebar">
        ...
        <ul className="list-unstyled list-wider list-categories">
          <li>
            <Link href={`/archives`}><a className="content-link text-uppercase">
              2000-2016
            </a></Link>
          </li>
        </ul>
